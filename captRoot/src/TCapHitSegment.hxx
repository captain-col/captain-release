#ifndef TCapHitSegment_hxx_seen
#define TCapHitSegment_hxx_seen
...
class CP::TCapHitSegment: public TNamed {
  public :
    TCapHitSegment();
    virtual ~TCapHitSegment();
    void clear();
